 ...
 * @date 2022-04-15
 * rozhraní knihovny htab (řešení IJC-DU2)
...
#define AVG_LEN_MIN 10  //prumerna delka seznamu
#define ARR_PTR_SIZE 10  //default delka pole v tabulce (zvolene aby se resize nevolal tak casto, pole ukazatelu stejne nezabira moc mista)
#define ARR_LIMIT 128   //limit pro pole nacitanych slov
...
htab_t * htab_resize(htab_t *t, size_t newn);       // změna velikosti pole
